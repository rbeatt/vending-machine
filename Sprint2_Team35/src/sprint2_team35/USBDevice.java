...
public class USBDevice {
	 ...
	 * @param insertDrive - true if a device is inserted and false if a device is not inserted
	 */
	...
	/**
	 * Mutator method for insertDrive.
	 * @param insertDrive - true if a device is inserted, false if a device is not inserted
	 */
	...
	/**
	 * Accessor method for deviceName
	...
	/**
	 * This method will change the state of insertDrive to true if a USB device has been inserted and display the drive letter of the name.
	 * @return - insertDrive boolean value
	 */

	public boolean detectUSB() {
		String[] driveLetters = new String[] { "A", "B", "C", "D", "E", "F", "G", "H", "I" }; // An array of drive letters
	...
	/**
	 * This method reads the contents of the "update" file stored on the USB memory device.
	 * @param directory - name of the USB drive
